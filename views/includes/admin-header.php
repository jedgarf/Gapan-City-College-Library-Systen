...
<head>
  ...
  <link rel="stylesheet" href="../../../library/jquery-contextmenu/jquery.contextMenu.min.css">

  <!-- Jquery Context Menu -->
  <script src="../../../library/jquery-contextmenu/jquery.contextMenu.js"></script>
  <script src="../../../library/jquery-contextmenu/jquery.ui.position.min.js"></script>
  ...
  <div class="side-navbar-wrapper">
    ...
    <div class="main-menu mt-3">
      ...
      <ul id="side-main-menu" class="side-menu list-unstyled">                  
        <li><a id="dashboard-button" title="Dashboard" href="#"> <i class="fa fa-columns"></i>Dashboard</a></li>

        <li><a id="borrowed-button" href="#" title="Borrowing Books"> <i class="fa fa-hand-lizard-o"></i>Borrowing</a></li>
        <li><a id="return-button" href="#" title="Returning Books"> <i class="fa fa-hand-lizard-o"></i>Returning</a></li>
        ...
        <li><a href="#bookDropdown" aria-expanded="false" data-toggle="collapse" title="Books"><i class="fa fa-book"></i>Books</a>
          <ul id="bookDropdown" class="collapse list-unstyled text-left">
            <li><a id="booklist-button" href="#" class="text-center" title="Book List">Book List</a></li>
            <li><a id="bookcat-button" href="#" class="text-center" title="Book Category">Book Category</a></li>
            <li><a id="bookinventory-button" href="#" class="text-center" title="Book Inventory">Book Inventory</a></li>
          </ul>
        </li>
        <li><a href="#studentDropdown" aria-expanded="false" data-toggle="collapse" title="Students"><i class="fa fa-users"></i>Students</a>
          <ul id="studentDropdown" class="collapse list-unstyled text-left">
            <li><a id="studentlist-button" href="#" class="text-center" title="Student List">Student List</a></li>
            <li><a id="studentpenalty-button" href="#" class="text-center" title="Student with Penalty">Student with Penalty</a></li>
          </ul>
        </li>
        <li><a href="#librarianDropdown" aria-expanded="false" data-toggle="collapse" title="Librarian"><i class="fa fa-users"></i>Librarian</a>
          <ul id="librarianDropdown" class="collapse list-unstyled text-left">
            <li><a id="librarianlist-button" href="#" class="text-center" title="Librarian List">Librarian List</a></li>
            <li><a id="librarianlogs-button" href="#" class="text-center" title="Librarian Login Logs">Librarian Logs</a></li>
            <li><a id="librarianpenalty-button" href="#" class="text-center" title="Deactivated Librarian Account">Blocked Account</a></li>
          </ul>
        </li>
        ...
        <li><a href="#settingDropdown" aria-expanded="false" data-toggle="collapse" title="Settings"><i class="fa fa-cog"></i>Settings</a>
          <ul id="settingDropdown" class="collapse list-unstyled text-left">
            <li><a id="adminprofile-button" href="#" class="text-center" title="Admin Profile">Admin Profile</a></li>
            <li><a id="generatedb-button" href="#" class="text-center" title="Genearating Database Backup">Generate Database Backup</a></li>
            <li><a id="about-button" href="#" class="text-center" title="About the Developer">About Us</a></li>
          </ul>
        </li>
